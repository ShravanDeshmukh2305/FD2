...
//
//    // Create MPIN with userRefId as a String
...
public class MpinService {
    ...
    public CreateMpinResponseDTO createMpin(CreateMpinRequestDTO mpinDto) {
        User user = userRepository.findByRefNo(mpinDto.getUserRefId())
                .orElseThrow(() -> new ResourceNotFoundException("User not found with ID: " + mpinDto.getUserRefId()));
        ...
        mpinData.setUserRefId(savedMpin.getUser().getRefNo()); // Use getRefNo() here
        ...
        response.setError(null); // No error occurred
